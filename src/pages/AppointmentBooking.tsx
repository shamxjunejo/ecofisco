...
emailjs.init("zgI0K2PftGCbEUiv_");
...
const AppointmentBooking: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Calculate a simple end time string without complex date parsing
            let [hourStr, minuteStr] = selectedTime.split(':');
            let [minutes, period] = minuteStr.split(' ');
            ...
            // Handle hour rollover for 12-hour format
            if (hour > 12) {
                hour -= 12;
            }
            
            const endTime = `${hour}:${minute.toString().padStart(2, '0')} ${period}`;
            ...
            try {
                ...
                const emailParams = {
                    ...
                    consultant_title: 'Immigration & Tax Consultant'
                };
                
                console.log("Email Parameters:", JSON.stringify(emailParams, null, 2));
                
                // Ensure service ID and template ID match exactly what's in your EmailJS dashboard
                ...
                <div className="rounded-xl overflow-hidden flex flex-col md:flex-row border border-gray-300 shadow-md bg-white">
                    ...
                    <div className="md:w-1/4 bg-gray-50 p-6 border-r border-gray-200">
                        <div className="flex flex-col h-full">
                            ...
                            <div className="mt-4 my-2 bg-blue-50 p-4 rounded-md border border-blue-100">
